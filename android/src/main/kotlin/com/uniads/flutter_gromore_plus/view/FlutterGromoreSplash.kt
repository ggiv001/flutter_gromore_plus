...
import com.uniads.flutter_gromore_plus.R
import com.uniads.flutter_gromore_plus.event.AdEvent
...
class FlutterGromoreSplash : AppCompatActivity() {
    ...
    private fun initAd() {
        ...
        this.adUnitId = adUnitId.toString()
    ...
    override fun onDestroy() {
        ...
        sendEvent("onAdEnd")
        DataReportUtil.report(adUnitId, AdEventType.Splash, "onAdEnd", null)
    }
        ...
        return object : CSJSplashAdListener {
            ...
            override fun onSplashLoadSuccess(ad: CSJSplashAd) {
                ...
                if (ad.splashView != null) {
                    ...
                    DataReportUtil.report(adUnitId, AdEventType.Splash, "onSplashAdLoadSuccess", null)
            ...
            override fun onSplashLoadFail(error: CSJAdError) {
                ...
                DataReportUtil.report(adUnitId, AdEventType.Splash, "onSplashAdLoadFail", null)
                finishActivity()
            }
            ...
            override fun onSplashRenderSuccess(ad: CSJSplashAd) {
                ...
                DataReportUtil.report(adUnitId, AdEventType.Splash, "onSplashRenderSuccess", null)
            ...
            override fun onSplashRenderFail(ad: CSJSplashAd, csjAdError: CSJAdError) {
                ...
                DataReportUtil.report(adUnitId, AdEventType.Splash, "onSplashRenderFail", null)
                finishActivity()
            }
        }
    }
    ...
    private fun getSplashAdListener(): CSJSplashAd.SplashAdListener {
        return object : CSJSplashAd.SplashAdListener {
            ...
            override fun onSplashAdShow(p0: CSJSplashAd?) {
                ...
                Log.d(TAG, "onAdShow")
                sendEvent("onAdShow")
                DataReportUtil.report(adUnitId, AdEventType.Splash, "onAdShow", null)
                ...
                skipAdTimer.schedule(6000) {
                    if (!isFinishing) {
                        runOnUiThread {
                            ...
                            DataReportUtil.report(adUnitId, AdEventType.Splash, "onAutoSkip", null)
                            finishActivity()
                        }
                    }
                }
            ...
            override fun onSplashAdClick(p0: CSJSplashAd?) {
                ...
                DataReportUtil.report(adUnitId, AdEventType.Splash, "onAdClicked", null)
            }
            ...
            override fun onSplashAdClose(p0: CSJSplashAd?, p1: Int) {
                ...
                DataReportUtil.report(adUnitId, AdEventType.Splash, "onSplashAdClose", null)
