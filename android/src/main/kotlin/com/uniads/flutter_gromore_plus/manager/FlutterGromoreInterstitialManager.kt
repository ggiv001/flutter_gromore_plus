...
//                .setAdCount(1) // 请求的广告数
    ...
    override fun onFullScreenVideoAdLoad(ad: TTFullScreenVideoAd?) {
        ad?.let {
            ...
            FlutterGromoreInterstitialCache.addCacheInterstitialAd(cacheId, it)
            FlutterGromoreInterstitialCache.addCacheInterstitialAdUnitId(cacheId, params["adUnitId"] as? String ?: "")
